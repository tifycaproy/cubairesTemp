...
<div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{ route('ingresarservicio')}}" method="POST" enctype="multipart/form-data">
 {{ csrf_field() }}
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group bmd-form-group {{ $errors->has('titulo_servicio') ? ' has-error' : '' }}">
                ...
                <input type="text" name="titulo_servicio" class="form-control" required autofocus>
          ...
          <div  class="row">
              ...
              <div class="col-md-3">
                  <div class="form-group bmd-form-group {{ $errors->has('oferta') ? ' has-error' : '' }}">
                    ...
                    <input type="number" step="0.01" max="100" min="0" name="oferta" class="form-control" >
                ...
                <div class="col-md-2">
                    <div class="form-group bmd-form-group {{ $errors->has('valoracion') ? ' has-error' : '' }}">
                      ...
                      <select class="form-control" name="valoracion" required>
                          <option value="0" selected="selected">0/5</option>                     
                  ...
                  <div class="col-md-2">
                      <div class="form-group bmd-form-group {{ $errors->has('destacado') ? ' has-error' : '' }}">
                        ...
                        <label id="destacado" class="form-check-label">
                          <input name="destacado" class="form-check-input" type="checkbox">
                          Destacado
                    ...
                    <div class="col-md-2">
                        <div class="form-group bmd-form-group {{ $errors->has('estatus') ? ' has-error' : '' }}">
                          ...
                          <label id="estatus" class="form-check-label">
                            <input name="estatus" class="form-check-input" type="checkbox">
                            Estatus
                            <span class="form-check-sign">
                              <span class="check"></span>
                            </span>
          ...
          <div class="row">
              ...
              <div class="form-group {{ $errors->has('descripcion') ? ' has-error' : '' }}">
                ...
                <div class="form-group bmd-form-group">
                    <textarea id="editor" name="descripcion" class="form-control" rows="4" required>&nbsp;</textarea>
          ...
          <div class="row">
            ...
            <div class="form-group {{ $errors->has('detalles') ? ' has-error' : '' }}">
              ...
              <div class="form-group bmd-form-group">
                  <textarea id="editor1" name="detalles" class="form-control" rows="4" required>&nbsp;</textarea>
          ...
          <div class="row">
            ...
            <div class="form-group {{ $errors->has('condiciones') ? ' has-error' : '' }}">
              ...
              <div class="form-group bmd-form-group">
                  <textarea id="editor2" name="condiciones" class="form-control" rows="4" required>&nbsp;</textarea>
          ...
          <div class="col-md-2">
            <div class="form-group bmd-form-group {{ $errors->has('categoria_id[]') ? ' has-error' : '' }}">
              ...
              <label  id="categoria_id_ch[]" class="form-check-label">
                <input id="categoria_id[]" name="categoria_id[]" value="{{$categoria->id}}" class="form-check-input check" type="checkbox">
          ...
          <input class="btn btn-primary pull-right" type="submit" value="Crear Paquete">
...
<script  type="text/javascript" charset="utf-8" >
  $('.check').change(function(){
    var check = $(this).val();
      if ($(this).is(':checked')) {
        $('.p'+check).prop('required', true);
      }else{
         $('.p'+check).prop('required', false);
      }
  });
</script>
@endpush
