...
<div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{ route('ingresarconfiguracion')}}" method="POST" enctype="multipart/form-data">
 {{ csrf_field() }}
              ...
              <div class="row">
                ...
                <div class="col-6 mt-4">
                 ...
                 <div class="col-8 mt-4">
                  <div class="form-group">
                    <label for="video">Texto Video</label>
                    <input type="text" class="form-control" value="@isset ($text_video) {{ $text_video }} @endisset" name="text_video" id="text_video" placeholder="">
                  </div>
                </div>
                ...
                <div class="col-6 mt-4">
                 ...
                 <div class="col-6 mt-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="@isset ($descripcion) {{ $descripcion }} @endisset" name="descripcion" id="descripcion" placeholder="" maxlength="200">
                  </div>
                </div>
                <div class="col-6 mt-4">
                  <div class="form-group">
                    <label for="descripcion">Descripción (Otro)</label>
                    <input type="text" class="form-control" value="@isset ($descripcion_opc) {{ $descripcion_opc }} @endisset" name="descripcion_opc" id="descripcion_opc" placeholder="" maxlength="200">
                  </div>
                </div>
                <div class="col-6 mt-4">
                  <div class="form-group">
                    <label for="meta_description">Meta Descripción</label>
                    <input type="text" class="form-control" value="@isset ($meta_description) {{ $meta_description }} @endisset" name="meta_description" id="meta_description" placeholder="" maxlength="200">
                  </div>
                </div>
                <div class="col-6 mt-4">
                  <div class="form-group">
