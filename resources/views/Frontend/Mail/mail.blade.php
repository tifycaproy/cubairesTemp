...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <td align="center" valign="top" width="100%" background="bg.jpg" bgcolor="#3b4a69" style="background: #3b4a69 url('{{ asset('images/slider-img-4.jpg') }}'); background-size: cover; padding: 50px 15px; filter: " class="mobile-padding">
            <!--[if (gte mso 9)|(IE)]>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                <tr>
                    <td align="center" valign="top" style="padding: 0 0 20px 0;">
                        <img src="{{ asset('images/logo.png') }}" width="80" height="80" border="0" style="display: block;">
                    </td>
                </tr>
                <tr>
                                ...
                                <td align="center" bgcolor="#ffffff" style="border-radius: 0 0 3px 3px; padding: 25px;">
                                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            ...
                                            <h2 style="font-size: 20px; color: #444444; margin: 0; padding-bottom: 10px;">{{$titulo}}</h2>
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td align="center" style="border-radius: 26px;" bgcolor="#75b6c9">
                                                            <a href="http://litmus.com" target="_blank" style="font-size: 16px; font-family: Open Sans, Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 26px; background-color: #75b6c9; padding: 14px 26px; border: 1px solid #75b6c9; display: block;">Read more &rarr;</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                <tr>
                    <td align="center" valign="top" style="padding: 0 0 5px 0;">
                        <img src="{{ asset('images/logo.png') }}" width="50" height="50" border="0" style="display: block;">
                    </td>
                </tr>
                <tr>
                    <td align="center" valign="top" style="padding: 0; font-family: Open Sans, Helvetica, Arial, sans-serif; color: #999999;">
                        <p style="font-size: 14px; line-height: 20px;">
                        	@isset ($meta_description) {{ $meta_description }} @endisset
                        	<br>
                        	<br>
                           @isset ($direccion) {{ $direccion }} @endisset
                          <br>
                          <a href="@isset ($meta_url) {{ $meta_url }} @endisset" >@isset ($meta_url) {{ $meta_url }} @endisset</a>
                          <br>
                          @isset ($telefono) {{ $telefono }} @endisset
                          &nbsp; &bull; &nbsp;
                          <a href="mailto:@isset($email){{$email}}@endisset" > @isset ($email) {{ $email }} @endisset</a>
